...
function findTopRelevantLineRangesClaude(code, query) {
  ...
  const semanticExpansions = {
    ...
    "metrics": ["metrics", "metricsexporter", "appendfile", "filepath", "readhistory"],
    "disk": ["disk", "diskusage", "checkdiskusage"],
    "filesystem": ["filesystem", "traversal", "readdirsync", "statsync", "recursive", "checkdiskusage"],
    ...
    "image": ["image", "imageproc", "processing", "img"],
    ...
    "export": ["export", "metricsexporter", "appendfile", "tojson"],
    "history": ["history", "readhistory", "readfile"]
  };
